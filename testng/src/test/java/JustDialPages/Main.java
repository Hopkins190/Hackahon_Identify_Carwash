...
public class Main {
	...
	public void setup() throws InterruptedException, IOException 
  {
	    ...
	    try {
	    	//Sending inputs from property file and startin the driver.
  	...
  	public void searchTextBoxAndRemoveAd() throws IOException 
  	{
		...
		try {
			//Sending inputs from property file and testing car wash page is passed or failed.
	...
	public void FitnessPage() throws IOException 
  	{
  		//Printing all the gym types in the excel sheet.
